...
#include "analysis/etaDalitz_CalibPID.h"
...
int main(int argc, char *argv[])
{
    ...
    TRint* app = LaunchRint("ant_etaDalitz_CalibPID", argc, argv, 4);
    ...
    ant::analysis::etaDalitz_CalibPID physics;
    analysis.AddPhysics(&physics);
